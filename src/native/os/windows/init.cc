...
//	extern __declspec (dllexport) PfnDliHook __pfnDliFailureHook2;
	...
	FARPROC WINAPI JNI3270_DelayLoadHook(unsigned reason, DelayLoadInfo * info);
...
#if defined(_MSC_VER)
 const PfnDliHook __pfnDliNotifyHook2 = JNI3270_DelayLoadHook;
 const PfnDliHook __pfnDliFailureHook2 = JNI3270_DelayLoadHook;
#else
 PfnDliHook __pfnDliNotifyHook2 = JNI3270_DelayLoadHook;
 PfnDliHook __pfnDliFailureHook2 = JNI3270_DelayLoadHook;
#endif // _MSC_VER
